...
# 比较并绘制图像
def plot_comparison(variable, exact_data, method_data, labels, title, xlabel,fontproperties=None):
...
for variable, xlabel in zip(["x0disy", "x0mise", "y0disx"], labels):
    ...
    plot_comparison(variable, exact_data, valid_data, valid_labels, f" {variable}的比较", xlabel,fontproperties=font_prop)
